...
export class InitiumMath {
    ...
    public static calcGravity(object1: HeavenlyBody, object2: HeavenlyBody) {
        ...
        // Calculate the real distance between the 2 sides (basicly the hypotenuse of the triangle)
        ...
        // gravitational force they apply with the formukla , Fgrav = (Gm1m2)/d^2;
